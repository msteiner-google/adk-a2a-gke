...
_INSTRUCTION = (
    ...
    "- Call exactly ONE specialist per turn. Never issue two specialist calls "
    "in the same turn, even when the sub-tasks look independent. Wait for the "
    "result, then decide the next step in light of what came back.\n"
    "- A sub-task that belongs to a specialist is theirs to answer. Do not work "
    "it out yourself to save a turn, and never build a later request around a "
    "value you assumed or computed — use the value the specialist returned.\n"
